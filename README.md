...
| 04 | 01_MCP_Primitives | MCP Prompts — single-turn & multi-turn prompts via `@mcp.prompt()` | [04.prompts.py](01_MCP_Primitives/04.prompts.py) | [notes](docs/01_MCP_Primitives/04.prompts.md) |
